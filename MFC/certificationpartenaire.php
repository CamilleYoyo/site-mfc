...
<head>
    <meta charset="utf-8">
    <title>Certification partenaire</title>
...
<body>
    ...
    <div class="flex">
        <div class="article">
            <p>
                <strong>Le groupe MFC s’associe avec des organismes certificateurs reconnus</strong><br><br>

                MFC déploie une offre de formation certifiante pour assurer la reconnaissance des compétences en nouant
                des partenariats avec des organismes de certifications reconnus par France compétences et éligibles au
                CPF.

            </p>
        </div>
        <div class="article">
            <img src="src/img/imag3.jpg" alt="Image de l'article">
        </div>
    </div>
