...
<body>
    ...
    <div class="block fond-contenair-contact">
        ...
        <form action="contact_submite.php" method="GET">
            ...
            <textarea id="message" name="message" placeholder="Exprimez vous" rows="4" required></textarea><br><br>
