...
if (!isset($_SESSION['email'])) {
    header("Location: page_personnalisee.php"); // Redirigez vers la page de connexion si l'utilisateur n'est pas connecté
    exit();
}
...
<body>
    ...
    <section class="presentation">
        <h2><strong>Formation en Application</strong></h2>
        ...
        <h3><strong>Coût :</strong></h3><br>
        <ol>
            <li>Tarif : 1200€ par participant</li>
        ...
        <ol>
            <li>Introduction au développement d'applications</li>
            <li>Langages de programmation utilisés</li>
            <li>Conception et architecture d'applications</li>
            <li>Test et débogage d'applications</li>
            <li>Déploiement et maintenance des applications</li>
        </ol><br><br>

        <h3><strong>Objectifs :</strong>
            <h3><br>
                <ol>
                    <li>Comprendre les principes fondamentaux du développement d'applications.</li>
                    <li>Maîtriser les langages de programmation couramment utilisés.</li>
                    <li>Concevoir des applications robustes et évolutives.</li>
                    <li>Tester et déboguer efficacement les applications.</li>
                    <li>Assurer le déploiement et la maintenance des applications de manière efficace.</li>
                </ol>

                <br><br>
                <p><strong>Public Cible : </strong>Cette formation s'adresse aux professionnels et aux étudiants intéressés par le développement d'applications, ainsi qu'aux développeurs souhaitant améliorer leurs compétences.</p>
                <br>
