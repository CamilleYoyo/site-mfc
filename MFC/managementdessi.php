...
<body>
    ...
    <section class="cours">
        <h2><strong>Formation en Management des Systèmes d'Information</strong></h2>

        <h3><strong>Date :</strong></h3>
        <ol>
            <li>Prochaine Session : Du 15 au 18 avril 2024</li>
            <li>Les dates des sessions suivantes seront annoncées prochainement.</li>
        </ol><br>

        <h3><strong>Coût :</strong></h3>
            <ol>
                <li>Tarif : 1500€ par participant</li>
                <li>Ce prix inclut le matériel pédagogique et les pauses café. Les repas ne sont pas inclus.</li>
            </ol><br>

            <h3><strong>Description de la Formation :</strong></h3>
            <ol>
                <li>Stratégie et gouvernance des SI</li>
                <li>Gestion des projets informatiques</li>
                <li>Sécurité des systèmes d'information</li>
                <li>Gestion des risques informatiques</li>
                <li>Gestion des données et des technologies émergentes</li>
            </ol><br>

            <h3><strong>Objectifs :</strong><h3>
                    <ol>
                        <li>Comprendre les enjeux stratégiques liés aux systèmes d'information.</li>
                        <li>Mettre en œuvre des pratiques de gestion de projet efficaces.</li>
                        <li>Appliquer des mesures de sécurité pour protéger les données et les systèmes.</li>
                        <li>Évaluer et gérer les risques liés aux technologies de l'information.</li>
                        <li>Utiliser les données comme un atout stratégique pour l'organisation.</li>
                    </ol>
                    </ol><br><br>
                    <p><strong>Public Cible : </strong>Cette formation s'adresse aux professionnels et aux managers travaillant dans les domaines de l'informatique, des systèmes d'information, de la gestion de projet ou de la stratégie d'entreprise.</p><br>
