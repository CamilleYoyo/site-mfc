...
<html>
    <head>
        <meta charset="utf-8">
        <title>Certification par métier</title>
        ...
        .article p {
            float: left;
            width: 100%; /* Ajustez la largeur du paragraphe selon vos besoins */
            margin-right: 20px;
        }
    ...
    <!--==========================================================================Nouvelle entete======================================-->
        ...
        <div class="flex">
            <div class="article">
                <p>
                    <strong>Besoin de reconnaissance, souhait d'évolution ou nécessité de reconversion ?</strong><br><br> 


                    Pour répondre aux besoins croissants des individus et des entreprises d’une reconnaissance officielle des compétences, nous proposons des parcours de formation certifiants dans de nombreux domaines.
                    
                    Reconnaissance de compétences transversales ( efficacité professionnelle, innovation, management…) ou plus directement liées à l’exercice d’un métier (Achats, commercial, finance, RSE...), nous proposons près de 150 formations menant à une certification des connaissances et compétences acquises.
            ...
            <div class="article">
                <img src="src/img/imag2.jpg" alt="Image de l'article">
            </div>
        </div>
