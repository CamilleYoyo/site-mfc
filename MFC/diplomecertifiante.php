...
<html>
    <head>
        <meta charset="utf-8">
        <title>Diplôme et Certifiante</title>
        ...
        .image-container img {
            width: 100%;
            max-width: 100%; /* Ajustez la taille de l'image selon vos besoins */
            height: auto;
            border: 10px;
        ...
        .tab3-content img {
            ...
            height: auto; /* Garantit que les proportions de l'image sont respectées */
            max-width: 300px; /* Ajustez la taille maximale selon vos besoins */
            border-radius: 8px;
            margin-bottom: 10px;
        }
    ...
    <!--==========================================================================Nouvelle entete======================================-->
        ...
        <!--essai-->
        <div class="tabs">
            <div class="tab" onclick="showTab('tab1')">Certifications par besoins RH</div>
            <div class="tab" onclick="showTab('tab2')">Certifications par métiers</div>
            <div class="tab" onclick="showTab('tab3')">Certifications partenraires</div>
        </div>

        <div class="flex">    
            <div class="tab-content tab1-content">
                <img src="src/img/imag0.jpg" alt="Image 1">
                <p>Il existe une solution certification MFC quels que soient les besoins RH de votre entreprise.<br>

                    <strong>Recrutement, professionnalisation ou reconversion</strong><br> Cliquez <a href="certifiationrh.php">ici</a> pour en savoir plus</p>
            </div>
        
            <div class="tab-content tab2-content">
                <img src="src/img/imag2.jpg" alt="Image 2">
                <p>Retrouvez nos parcours de formation certifiants dans de nombreux domaines :<br>

                <strong> Achats, management, projets, efficacité professionnelle...</strong><br> Cliquez <a href="certificationmetier.php">ici</a> pour en savoir plus</p></p>
            </div>
        
            <div class="tab-content tab3-content">
                <img src="src/img/imag3.jpg" alt="Image 3">
                <p>Découvrez nos formations certifiantes en partenariat avec des organismes reconnus :<br>

                    <strong> Certifications internationales, labels éditeurs...</strong> <br>Cliquez <a href="certificationpartenaire.php">ici</a> pour en savoir plus</p></p>
            </div>
        </div>
