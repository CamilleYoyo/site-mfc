...
if (isset($_SESSION['email'])) {
    header("Location: page_personnalisee.php"); // Redirigez vers la page personnalisée si l'utilisateur est connecté
    exit();
}
        ...
        <div class="banner">
            ...
            <div class="conteneur1">
                ...
                <div class="bloc-cache1">
                    ...
                    <br>
                    <a href="Formulaireinscri.php" class="btn1 unibtn">
            ...
            <div class="conteneur2">
                ...
                <div class="bloc-cache2">
                    ...
                    <br>
                    <a href="Formulaireinscri.php" class="btn2 unibtn">
                        Remplir la Fiche d'inscription
                    </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="first-col">
                        ...
                        <div class="col-sm-6 col-md-3 item first-col-footer-2"><br><br>
